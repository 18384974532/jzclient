...
// source: D:\unityp1\jzclient.git\trunk\testproj\Assets\Sproto\protocol\/game.sproto
...
namespace SprotoType { 
	public class chat {
		...
		public class request : SprotoTypeBase {
			...
			private string _sender; // tag 0
			public string sender {
				get { return _sender; }
				set { base.has_field.set_field (0, true); _sender = value; }
			}
			...
			public override int encode (SprotoStream stream) {
				...
				if (base.has_field.has_field (0)) {
					base.serialize.write_string (this.sender, 0);
				}
